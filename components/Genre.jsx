...
export default function Genre() {
  ...
  return (
    <div className="genre">
        ...
        <svg id="toLeft" onClick={()=>scrollIt(false)} width="36" height="36" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg id="toRight" onClick={()=>scrollIt(true)} width="36" height="36" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="genrecontainer">
...

        {
          ...
          <div className="options">
            <p onClick={(e)=>select(e)}>Action</p>
            <p onClick={(e)=>select(e)}>Drama</p>
            <p onClick={(e)=>select(e)}>Adventure</p>
          </div>
        }
